...
DROP USER IF EXISTS 'strava_user'@'localhost';
...
CREATE USER IF NOT EXISTS 'strava_user'@'localhost' IDENTIFIED BY 'Password1?';
/* GRANT FULL ACCESS TO THE DATABASE FOR THE USER 'strava_user' AT LOCAL SERVER*/
GRANT ALL ON stravaDB.* TO 'strava_user'@'localhost';
